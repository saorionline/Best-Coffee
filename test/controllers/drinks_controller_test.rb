...
class DrinksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create drink" do
    assert_difference("Drink.count") do
      post drinks_url, params: { drink: { amount: @drink.amount, name: @drink.name, origin: @drink.origin, price: @drink.price } }
    end
  ...
  test "should update drink" do
    patch drink_url(@drink), params: { drink: { amount: @drink.amount, name: @drink.name, origin: @drink.origin, price: @drink.price } }
